...
<html>
 ...
 <h4> <p style="display:inline;color:blue" title="Enumerations (numerical listing)"> संख्यैकान्ताः  </p> </h4>
 <h5> श्लो.  १.१.१ - १.१.२ : </h5>

<?php
// Change character set to utf8
mysqli_set_charset($db,"utf8");
$query = "select * from mmrsv where ChapterS='सिद्धान्तविचारः ' and SectionS='संख्यैकान्ताः '";
