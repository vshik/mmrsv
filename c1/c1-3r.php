...
<html>
 ...
 <h4> <p style="display:inline;color:blue" title="About the Text"> प्रबन्धविषयः </p> </h4>
 <h5>श्लो.  १.३.१ - १.३.९ : </h5>


<?php
// Change character set to utf8
mysqli_set_charset($db,"utf8");
$query = "select * from mmrsv where ChapterS='पीठिका ' and SectionS='प्रबन्धविषयः '";
