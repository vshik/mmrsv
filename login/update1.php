					    ...
					    <div class="controls">
					      	...
					      	<?php endif;?>
                                         ...
                                         <div class="control-group <?php echo !empty($ShlokaError)?'error':'';?>">
                                            ...
                                            <div class="controls">
                                                <input name="Shloka" type="text" style="overflow-y" placeholder="Shloka" value="<?php echo !empty($Shloka)?$Shloka:'';?>">
                                         ...
                                         <div class="control-group <?php echo !empty($ShlokaMeaningError)?'error':'';?>">
                                            ...
                                            <div class="controls">
                                                <input name="ShlokaMeaning" type="text" style="overflow-y" placeholder="Shloka Meaning" value="<?php echo !empty($ShlokaMeaning)?$ShlokaMeaning:'';?>">
                                         ...
                                         <div class="control-group <?php echo !empty($ReferenceError)?'error':'';?>">
                                            ...
                                            <div class="controls">
                                                <input name="Reference" type="text" style="overflow-y" placeholder="Reference" value="<?php echo !empty($Reference)?$Reference:'';?>">
